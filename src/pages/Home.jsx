...
const subjectConfig = {
  mathematics:                    { Icon: Calculator,   desc: 'Numbers, Algebra, Geometry, Mensuration, Data Handling and more.' },
  science:                        { Icon: FlaskConical, desc: 'Physics, Chemistry, Biology chapters with NCERT resources.' },
  english:                        { Icon: Languages,    desc: 'Poorvi — prose, poetry, and supplementary readers.' },
  'social-science':               { Icon: Landmark,     desc: 'History, Geography, Political Science, and Social topics.' },
  hindi:                          { Icon: BookMarked,   desc: 'Malhar — all Hindi books and chapters.' },
  sanskrit:                       { Icon: Scroll,       desc: 'Deepakam — Sanskrit textbook chapters.' },
  'physical-education-and-well-being': { Icon: HeartPulse, desc: 'Physical education, yoga, sports and health.' },
  urdu:                           { Icon: PenLine,      desc: 'Khayal — Urdu textbooks and supplementary readers.' },
  arts:                           { Icon: PenLine,      desc: 'Kriti I — arts and craft chapters.' },
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title="CBSE Class 6 AI Study Prompts"
        description="Free chapter-wise AI prompts for CBSE Class 6 across all subjects. Use with ChatGPT, Gemini, or Claude to study smarter and score better."
      />
      <Navbar />
          ...
          <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 items-start">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-3">
                CBSE Class 6<br />Most Effective<br/>
                <h1 className="text-4xl lg:text-5xl font-bold text-blue-600 leading-tight tracking-tight mb-3">
                  Prompts
                </h1>
              </h1>
              <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-md">
                Free chapter-wise NCERT prompts, structured by subject, book, and chapter for CBSE Class 6 students
              </p>
