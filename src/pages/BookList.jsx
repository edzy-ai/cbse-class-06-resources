...
const subjectColorClass = {
  ...
  'physical-education-and-well-being': 'text-teal-500', urdu: 'text-violet-500',
  arts: 'text-rose-500', 'vocational-education': 'text-amber-500',
}
...
export default function BookList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 6 ${fmt(subject)} – ${fmt(book)}`}
        description={`Browse all ${fmt(book)} chapters for CBSE Class 6 ${fmt(subject)}. Access free AI prompts for every chapter — Quick Understanding, Practice Questions, Quick Review, Find My Mistake, and Exam Prep — to use with ChatGPT, Gemini, or Claude.`}
      />
      <Navbar />
      <main className="flex-1">
        <div className="bg-white border-b border-gray-100 px-6 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">CBSE Class 6 {fmt(subject)}</h1>
