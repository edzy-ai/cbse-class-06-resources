...
const subjectMeta = {
  ...
  arts:                                { Icon: PenLine,      colorClass: 'text-rose-500',   bgClass: 'bg-rose-50'   },
...
export default function SubjectList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 6 ${fmt(subject)} Prompts`}
        description={`Explore all ${fmt(subject)} books and chapters for CBSE Class 6. Access free AI prompts for every chapter to use with ChatGPT, Gemini, and Claude. Perfect for quick understanding, practice questions, and exam preparation.`}
      />
      <Navbar />
